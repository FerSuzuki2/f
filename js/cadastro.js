...
function radio() {
  if (
    document.form.sexo[0].checked == false &&
    document.form.sexo[1].checked == false &&
    document.form.sexo[2].checked == false
  ) {
    ...
    document.form.sexo[0].checked == true &&
    document.form.sexo[1].checked == false &&
    document.form.sexo[2].checked == false
  ) {
    ...
    document.form.sexo[0].checked == false &&
    document.form.sexo[1].checked == true &&
    document.form.sexo[2].checked == false
  ) {
    ...
    document.form.sexo[0].checked == false &&
    document.form.sexo[1].checked == false &&
    document.form.sexo[2].checked == true
  ) {
